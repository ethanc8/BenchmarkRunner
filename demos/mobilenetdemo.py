# Based on https://docs.opencv.org/4.x/dc/db4/tf_segm_tutorial_dnn_conversion.html
# and https://github.com/opencv/opencv/blob/4.x/samples/dnn/dnn_model_runner/dnn_conversion/tf/classification/py_to_py_mobilenet.py
import os
